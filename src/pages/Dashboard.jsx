  ...
  return (
    <div className="wow-page">
      ...
      <div className="wow-content container-fluid">
        {isDashboardOffline && (
          <div className="alert alert-warning d-flex align-items-center justify-content-between gap-3" role="alert" aria-live="assertive">
            <span>Dashboard data is unavailable because Central cannot be reached.</span>
            <button type="button" className="btn btn-sm btn-outline-dark" onClick={retryDashboard}>
              Retry dashboard
            </button>
          </div>
        )}
