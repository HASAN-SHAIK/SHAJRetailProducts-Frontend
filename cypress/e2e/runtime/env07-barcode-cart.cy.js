describe('ENV-07 barcode scanner to POS/cart runtime', () => {
  ...
  const product = {
    id: 'env07-product-1',
    product_id: 'env07-product-1',
    name: 'ENV07 Runtime Milk',
    product_name: 'ENV07 Runtime Milk',
    barcode,
    selling_price: 42,
    mrp: 45,
    gst_percentage: 5,
